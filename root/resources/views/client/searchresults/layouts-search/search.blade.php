...
<div class="w-full h-auto bg-[#feb704] absolute top-[113%] rounded-lg">
    <form id="searchForm" action="{{ route('client.search') }}" method="GET">
        @csrf
        <div class="p-1 flex items-center justify-between w-full h-full">
            <div class="w-[40%]">
                ...
                <div class="focus-parent relative">
                    <button type="button"
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="block overflow-hidden text-ellipsis whitespace-nowrap w-[80px]">{{__('content.search.check_in')}}</span> -
                            <span class="block overflow-hidden text-ellipsis whitespace-nowrap w-[80px]">{{__('content.search.check_out')}}</span>
                        </div>
                    </button>
                    <!-- Datepicker -->
                    ...
                    <div  class="focus-child hidden">
                        <div class="flex justify-between items-center z-10 top-[104%] p-4 gap-[24px] absolute  w-80 md:w-[40.4rem] bg-white border shadow-lg rounded-xl overflow-hidden">
                ...
                <button type="button" id="displayButton"
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-8" viewBox="0 0 448 512" fill="currentColor">
                                <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm112 32h-16a174.6 174.6 0 0 1-192 0h-16A112 112 0 0 0 0 400v16a96 96 0 0 0 96 96h256a96 96 0 0 0 96-96v-16a112 112 0 0 0-112-112z" />
                            </svg>
                        </div>
                        <span id="roomPeopleText">
                            {{ $defaultAdults }} {{__('content.search.quantity_people_old')}} · {{ $defaultRooms }} {{__('content.search.quantity_room')}}
                        </span>
                    </div>
                </button>

                <div id="roomSelector" class="hidden absolute bg-white border shadow-xl rounded-lg p-4 w-full min-w-[350px]">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <div class="border border-[#858585] rounded-lg">
                            ...
                            <input type="text" id="adultsCount" name="people_old" 
                                value="{{ $defaultAdults }}" readonly 
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="border border-[#858585] rounded-lg">
                            ...
                            <input type="text" id="roomsCount" name="rooms" 
                                value="{{ $defaultRooms }}" class="w-8 mx-[12px] text-center border-none">
            ...
            <div class="w-[6%]">
                <button type="submit" id="submitButton"
                    class="bg-[#006ce3] p-[14px] w-full rounded-lg text-xl text-white font-medium">{{__('content.search.search')}}</button>
            </div>
        </div>
    </form>
</div>
