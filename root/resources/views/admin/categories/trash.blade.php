                    ...
                    <div class='flex items-center justify-between gap-8 mb-8'>
                        <div>
                            <h5
                                ...
                                {{ __('content.category.trash_list') }}
                            </h5>
                        </div>
                        <div class='flex flex-col gap-2 shrink-0 sm:flex-row'>
                            <a href="{{ route('admin.categories.index') }}" 
                                class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>
                                {{ __('content.category.back') }}
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="items-center w-full bg-transparent border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th
                                    class="px-4 bg-gray-100 align-middle border border-solid border-gray-200 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">
                                    {{ __('content.category.deleted_at') }}</th>
                                <th
                                ...
                                <tr class="text-gray-700">
                                    ...
                                    <td
                                        ...
                                        <button
                                            ...
                                            type='button' title='{{ __('content.category.delete_permanent') }}'
                                            data-id='{{ $category->id }}'>
            ...
            $(document).on('click', '.delete-permanent-button', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: `/admin/categories/forceDelete/${id}`,
                            type: 'GET',
                            data: {
                                _token: $('meta[name="csrf-token"]').attr('content')
                            },
