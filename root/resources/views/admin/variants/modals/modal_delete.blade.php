<dialog id='modal_delete_variant' class='modal rounded-[24px]'>
    <div class='modal-box flex-col font-[sans-serif] bg-white max-w-4xl flex items-center mx-auto min-w-[400px] p-4'>
        ...
        <h2 class='mb-4 text-xl font-bold text-gray-900 '>{{ __('content.variant.delete_variant') }}</h2>
        <section class='bg-white w-full flex justify-center w-[80%]'>
            <div class='pt-4 pb-8 px-4'>
                <form id='form_delete_variant'
                    method="POST">
                    @csrf
                    @method('DELETE')
