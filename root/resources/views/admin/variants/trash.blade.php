                                ...
                                <tr class="text-gray-700">
                                    ...
                                    <td
                                        ...
                                        <button
                                            ...
                                            type='button' title='{{ __('content.variant.restore') }}'
                                            data-id='{{ $variant->id }}'>
                                        ...
                                        <button
                                            ...
                                            type='button' title='{{ __('content.variant.delete_permanent') }}'
                                            data-id='{{ $variant->id }}'>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.restore-button', function() {
                ...
                Swal.fire({
                    ...
                    text: "Bạn có muốn khôi phục biến thể này?",
                    icon: 'warning',
                ...
                $(document).on('click', '.delete-permanent-button', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                url: `/admin/variants/forceDelete/${id}`,
                                type: 'GET',
                                data: {
