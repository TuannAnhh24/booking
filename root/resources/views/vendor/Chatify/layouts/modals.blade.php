  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">{{ __('content.chatuser.delete_question') }}</div>
              <div class="app-modal-body">{{ __('content.chatuser.not_back') }}</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">{{ __('content.chatuser.cancel') }}</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">{{ __('content.chatuser.delete') }}</a>
              </div>
          </div>
      </div>
  </div>
              ...
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      <label class="app-btn a-btn-primary update" style="background-color:{{$messengerColor}}">
                          {{ __('content.chatuser.upload_new') }}
                  ...
                  <div class="app-modal-footer">
                      <a href="javascript:void(0)" class="app-btn cancel">{{ __('content.chatuser.cancel') }}</a>
                      <input type="submit" class="app-btn a-btn-success update" value="{{ __('content.chatuser.save_changes') }}" />
                  </div>
              </form>
          </div>
      </div>
