...
class EditPromotionRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'discount_type-edit' => 'required|in:percentage,amount',
            'discount_percentage' => 'nullable|required_if:discount_type-edit,percentage|numeric|min:1|max:100',
            'discount_amount' => 'nullable|required_if:discount_type-edit,amount|numeric|min:10000',
