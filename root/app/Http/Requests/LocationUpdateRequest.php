...
class LocationUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'characteristicsEdit' => 'required|min:1', // Thêm quy tắc cho characteristic
    ...
    public function messages(): array
    {
        return [
            ...
            'characteristicsEdit.required' => __('content.requests.characteristic_required'), // Thông báo khi không chọn characteristic
